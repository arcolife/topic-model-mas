...
#
# ------------------------------------------------------------------------------
"""This module contains the data classes for the Note-Taking ABCI application."""
...
from packages.topic_aggregator.skills.topic_extractor.payloads import (
    NoteTakingPayload,
    RegistrationPayload,
    ResetPayload,
    SelectKeeperPayload,
...
class Event(Enum):
    """Event enumeration for the Note-Taking ABCI demo."""
...
class NoteTakingABCIAbstractRound(AbstractRound[Event, TransactionType], ABC):
    """Abstract round for the Note-Taking ABCI skill."""
...
class RegistrationRound(CollectDifferentUntilAllRound, NoteTakingABCIAbstractRound):
...
class SelectKeeperRound(CollectSameUntilThresholdRound, NoteTakingABCIAbstractRound):
...
class SaveTopicsRound(CollectDifferentUntilAllRound, NoteTakingABCIAbstractRound):
    """A round in which the agents get registered"""

    round_id = "print_message"
    allowed_tx_type = NoteTakingPayload.transaction_type
...
class ResetAndPauseRound(CollectSameUntilThresholdRound, NoteTakingABCIAbstractRound):
...
class NoteTakingAbciApp(AbciApp[Event]):
    """NoteTakingAbciApp
